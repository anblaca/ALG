...
if __name__ == "__main__":
    ...
    parser.add_argument('-Z', '--spellsuggest', dest='spellsuggest', action='store_true', default=False,
                    help='Busqueda con errores results.')
    ...
    #Para el caso de spellsuggest
    searcher.set_spellsuggester(args.spellsuggest)
